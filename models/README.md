...
The trained model file (`random_forest_model.pkl`) is not included in this repository because it exceeds GitHub's recommended file size limits.

The model can be regenerated by running the notebook:

`notebooks/04_demand_forecasting.ipynb`

This notebook trains the model and saves it locally in the `models/` directory.
